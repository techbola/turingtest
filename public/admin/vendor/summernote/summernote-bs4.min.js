...
!function (t, e) {
    ...
    var Vt = function () {
        ...
        return t.prototype.representShortcut = function (t) {
            ...
            return this.options.shortcuts && e ? (z.isMac && (e = e.replace("CMD", "âŒ˜").replace("SHIFT", "â‡§")), " (" + (e = e.replace("BACKSLASH", "\\").replace("SLASH", "/").replace("LEFTBRACKET", "[").replace("RIGHTBRACKET", "]")) + ")") : ""
